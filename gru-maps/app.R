...
ui <- fluidPage(
    ...
    column(
        ...
        sidebarPanel(
            ...
            h5("MAIN DIRECTORATE OF THE GENERAL STAFF OF THE ARMED FORCES OF THE RUSSIAN FEDERATION"), 
            h5("****TOP SECRET***"), 
            br(), 
            h5("This interactive map shows major sites in the American nuclear weapons complexes, including 
